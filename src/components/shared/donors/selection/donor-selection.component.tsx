...
import '../../elements/react-table/table.css';
...
import { EffektModal } from '../../elements/effekt-modal/effekt-modal.component.style';
import { CreateDonor } from '../create/create-donor.component';
import {
  searchDonorAction,
  setSelectedDonor,
} from '../../../../store/donor/select/donor-selection.actions';
...
export const DonorSelectionComponent: React.FunctionComponent = (props) => {
  ...
  const searchResult = useSelector(
    (state: AppState) => state.donorSelector.searchResult,
  );
...
{' '}
      ...
      >
        <CreateDonor onSubmit={() => setShowCreate(false)} />
      </EffektModal>
      <ReactTable
        data={searchResult}
