...
export const TotalDonationAmount: React.FunctionComponent<IProps> = ({ totalDonationAmount, operationsDonationAmount }) => {
    return (
            ...
            <table width="100%" cellSpacing={0}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> kr {thousandize(
                            Number((totalDonationAmount - operationsDonationAmount).toFixed(2)))} </td>
                    </tr>
                </tbody>
            </table>
        </TotalDonationAmountWrapper>
