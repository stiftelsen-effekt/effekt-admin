...
import { LOGIN_BEGIN, LOGOUT_REQUEST, LOGIN_CACHE_CHECK, LOGIN_CALLBACK, LOGIN_SUCCESS } from './auth/loginout.actions';
...
import { deleteDonationAction, fetchDonationsAction } from './donations/list/donations-list.actions';
import { fetchDonationAction, fetchHistogramAction } from './donations/donation/donation.actions';
...
import { callback, login, loginCacheCheck, loginSuccess, logout } from './auth/loginout.saga';
...
import { createDistribitionAndInsertDonationAction, fetchPaymentMethodsAction, insertDonationAction } from './donations/donation/single/single-donation.actions';
import { createDistributionAndInsertDonation, fetchPaymentMethods, insertDonation } from './donations/donation/single/single-donation.saga';
import { uploadReportAction } from './report/report-upload.actions';
import { createDonor } from './donor/create/create-donor.saga';
import { fetchDonation, fetchHistogram } from './donations/donation/donation.saga';
import { fetchDonations, deleteDonation } from './donations/list/donations-list.saga';
