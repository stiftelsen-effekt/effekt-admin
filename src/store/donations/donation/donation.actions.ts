...
import { IDonation, IHistogramBucket } from "../../../types";
...
export const fetchHistogramAction = actionCreator.async<undefined, Array<IHistogramBucket>, Error>('FETCH_HISTOGRAM');
