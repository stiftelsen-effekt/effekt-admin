...
export interface IFetchAvtaleGiroMissingByDateParams { date: DateTime }
...
export const fetchAvtaleGiroMissingByDateAction = actionCreator.async<IFetchAvtaleGiroMissingByDateParams, Array<IAvtaleGiro>, Error>('FETCH_AVTALEGIRO_MISSING_BY_DATE');
